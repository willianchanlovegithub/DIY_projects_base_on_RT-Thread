 ...
 * 2019-08-01     WillianChan  DIY Demo4(Fourth week mission)雏形版本！！！草稿版本！！！什么都不要相信！！！
 * 2019-08-01     WillianChan  Say again：雏形版本！！！草稿版本！！！什么都不要相信！！！
 */
...
static FILE *recvdatafile_p0 = RT_NULL;             /* 文件指针 */
...
static void onenet_mqtt_init_entry(void *parameter)
{
    ...
    while (1)
    {
        ...
        {
            /* mqtt初始化成功之后，释放信号量告知onenet_upload_data_thread线程 */
...
static void onenet_upload_data_entry(void *parameter)
{
    ...
    /* 删除onenet_mqtt_init_entry线程，回收系统资源 */
